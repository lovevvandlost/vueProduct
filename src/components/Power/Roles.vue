 ...
 * @Description: 
 * @Author:  
 * @Date: 2021-11-01 19:40:25
 * @LastEditTime: 2021-11-03 20:19:40
 * @LastEditors:  
-->
<template>
  <div class="roles">
                ...
                <el-row :class="['bdtop', i1 === 0 ? 'bdbottom' : '', 'vcenter']" v-for="(item1, i1) in scope.row.children" :key="item1.id">
                  ...
                  <el-col :span="19">
                    ...
                    <el-row v-for="(item2, i2) in item1.children" :key="item2.id" :class="[i2 === 0 ? '' : 'bdtop', 'vcenter']">
                      ...
                      <el-col :span="18">
                        <el-tag type="warning" closable :class="[i3 === 0 ? '' : 'bdtop']" v-for="(item3, i3) in item2.children" :key="item3.id" @close="removeRightById(scope.row, item3.id)">{{ item3.authName }}</el-tag>
                      </el-col>
                    </el-row>
                  </el-col>
                </el-row>
