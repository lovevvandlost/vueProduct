 ...
 * @Description: 
 * @Author:  
 * @Date: 2021-11-01 19:43:54
 * @LastEditTime: 2021-11-04 16:27:35
 * @LastEditors:  
-->
<template>
  <div class="list">
    ...
    <el-card>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="queryInfo.pagenum" :page-sizes="[7, 11, 15, 19]" :page-size="queryInfo.pagesize" layout="total, sizes, prev, pager, next, jumper" :total="total">
      </el-pagination>
    </el-card>
  </div>
</template>
